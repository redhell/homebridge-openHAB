...
ThermostatItem.prototype.checkItemState = function(state) {
...
ThermostatItem.prototype.updateCharacteristics = function(message) {
    this.otherService
        ...
        .getCharacteristic(this.homebridge.hap.Characteristic.TemperatureDisplayUnits)
        .getCharacteristic(this.homebridge.hap.Characteristic.CurrentHeatingCoolingState);
        .setValue(this.checkItemState(message));
};

ThermostatItem.prototype.getItemState = function(callback) {
